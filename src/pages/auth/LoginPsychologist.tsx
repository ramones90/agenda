        ...
        <div className="bg-white p-12 lg:p-16 rounded-[4rem] shadow-2xl shadow-stone-200 border border-stone-100">
          ...
          <div className="flex flex-col items-center mb-12">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="text-[10px] font-bold text-stone-400 uppercase tracking-[0.2em]">Área do Psicólogo</h4>
            </div>
            <h1 className="text-4xl font-serif italic text-stone-900 text-center">Gestão Clínica</h1>
            <p className="text-stone-500 text-center mt-4 font-serif italic text-lg leading-relaxed">
              Acompanhe a jornada de seus pacientes com dedicação e profissionalismo.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-bold text-stone-400 uppercase tracking-[0.2em] ml-2">Senha de Acesso</label>
              <div className="relative">
            ...
            <div className="text-center pt-8 border-t border-stone-50">
              <p className="text-stone-500 font-serif italic text-lg">
                ...
                <button type="button" className="text-stone-900 font-bold hover:underline">
                  Recuperar senha
                </button>
              </p>
            </div>
