        ...
        <div className="bg-white p-12 lg:p-16 rounded-[4rem] shadow-2xl shadow-stone-200 border border-stone-100">
          ...
          <div className="flex flex-col items-center mb-12">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <h4 className="text-[10px] font-bold text-stone-400 uppercase tracking-[0.2em]">Administração</h4>
            </div>
            <h1 className="text-4xl font-serif italic text-stone-900 text-center">Painel de Controle</h1>
            <p className="text-stone-500 text-center mt-4 font-serif italic text-lg leading-relaxed">
              Gestão da plataforma e suporte à jornada de todos.
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-bold text-stone-400 uppercase tracking-[0.2em] ml-2">Email Administrativo</label>
